...
<head>
  ...
  <title>Employee Portal - User Management</title>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Pinelopi Nastou</span>
              </a>
...
<head>
  ...
  <title>Employee Portal - User </title>
          ...
          <div class="row">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">User info</h1>
              </div>
              <form class="user">
